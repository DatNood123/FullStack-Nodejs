...
let getListCustomerForStaffById = async (req, res) => {
    try {
        let info = await doctorService.getListCustomerForStaffByIdService(req.query.id, req.query.date);
        return res.status(200).json(
            info
        )
    } catch (e) {
...
let sendResultSurvey = async (req, res) => {
    try {
        let info = await doctorService.sendResultSurveyService(req.body);
        return res.status(200).json(
            info
        )
    } catch (e) {
...
module.exports = {
    ...
    getListCustomerForStaffById: getListCustomerForStaffById,
    sendResultSurvey: sendResultSurvey
}